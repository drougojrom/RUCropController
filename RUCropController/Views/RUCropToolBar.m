...
- (void)setup {
    ...
    [_doneIconButton setImage:[RUCropToolBar doneImage] forState:UIControlStateNormal];
    ...
    [_cancelIconButton setImage:[RUCropToolBar cancelImage] forState:UIControlStateNormal];
    ...
    [_clampButton setImage:[RUCropToolBar clampImage] forState:UIControlStateNormal];
    ...
    [_rotateCounterclockwiseButton setImage:[RUCropToolBar rotateCCWImage] forState:UIControlStateNormal];
    ...
    [_resetButton setImage:[RUCropToolBar resetImage] forState:UIControlStateNormal];
...
- (void)setRotateClockwiseButtonHidden:(BOOL)rotateClockwiseButtonHidden
{
    ...
    if (_rotateClockwiseButtonHidden == NO) {
        ...
        [_rotateClockwiseButton setImage:[RUCropToolBar rotateCWImage] forState:UIControlStateNormal];
