...
#import "RUCropView.h"
#import "RUCropToolbar.h"

typedef NS_ENUM(NSInteger, RUCropViewControllerAspectRatioPreset) {
    RUCropViewControllerAspectRatioPresetOriginal,
    RUCropViewControllerAspectRatioPresetSquare,
    RUCropViewControllerAspectRatioPreset3x2,
    RUCropViewControllerAspectRatioPreset5x3,
    RUCropViewControllerAspectRatioPreset4x3,
    RUCropViewControllerAspectRatioPreset5x4,
    RUCropViewControllerAspectRatioPreset7x5,
    RUCropViewControllerAspectRatioPreset16x9,
    RUCropViewControllerAspectRatioPresetCustom
};

typedef NS_ENUM(NSInteger, RUCropViewControllerToolbarPosition) {
    RUCropViewControllerToolbarPositionTop,
    RUCropViewControllerToolbarPositionBottom
};

@class RUCropViewController;
...
@protocol RUCropViewControllerDelegate <NSObject>
@optional
 ...
 */
- (void)cropViewController:(nonnull RUCropViewController *)cropViewController didCropImageToRect:(CGRect)cropRect angle:(NSInteger)angle NS_SWIFT_NAME(cropViewController(_:didCropToRect:angle:));
...
/**
 ...
 @param angle The angle of the image when it was cropped
 */
- (void)cropViewController:(nonnull RUCropViewController *)cropViewController didCropToImage:(nonnull UIImage *)image withRect:(CGRect)cropRect angle:(NSInteger)angle NS_SWIFT_NAME(cropViewController(_:didCropToImage:rect:angle:));
...
/**
 ...
 @param angle The angle of the image when it was cropped
 */
- (void)cropViewController:(nonnull RUCropViewController *)cropViewController didCropToCircularImage:(nonnull UIImage *)image withRect:(CGRect)cropRect angle:(NSInteger)angle NS_SWIFT_NAME(cropViewController(_:didCropToCircleImage:rect:angle:));
 ...
 */
- (void)cropViewController:(nonnull RUCropViewController *)cropViewController didFinishCancelled:(BOOL)cancelled NS_SWIFT_NAME(cropViewController(_:didFinishCancelled:));

@end

@interface RUCropViewController : UIViewController
 ...
 */
@property (nullable, nonatomic, weak) id<RUCropViewControllerDelegate> delegate;
 ...
 */
@property (nonnull, nonatomic, strong, readonly) RUCropView *cropView;
 ...
 */
@property (nonnull, nonatomic, strong, readonly) RUCropToolBar *toolbar;

/**
 The cropping style of this particular crop view controller
 */
@property (nonatomic, readonly) RUCropViewCroppingStyle croppingStyle;

/**
 A choice from one of the pre-defined aspect ratio presets
 */
@property (nonatomic, assign) RUCropViewControllerAspectRatioPreset aspectRatioPreset;
 ...
 */
@property (nonatomic, assign) RUCropViewControllerToolbarPosition toolbarPosition;
 ...
 */
- (nonnull instancetype)initWithCroppingStyle:(RUCropViewCroppingStyle)style image:(nonnull UIImage *)image NS_SWIFT_NAME(init(croppingStyle:image:));
 ...
 */
- (void)setAspectRatioPreset:(RUCropViewControllerAspectRatioPreset)aspectRatioPreset animated:(BOOL)animated NS_SWIFT_NAME(setAspectRatioPresent(_:animated:));
